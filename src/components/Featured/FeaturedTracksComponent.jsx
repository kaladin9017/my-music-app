...
import FeaturedTracksCards from './FeaturedTracksCards';
import LoaderComponent from '../common/LoaderComponent';

class FeaturedTracksComponent extends Component {
  ...
  render() {
    ...
    if(data) {
      ...
      const cardList =[]
      for(let i=0;i<12;i++){
        cardList.push(<FeaturedTracksCards data={tracks[i]} key={i}/>)
      }
      return (
...
export default connect(mapStateToProps, mapDispatchToProps)(FeaturedTracksComponent);
